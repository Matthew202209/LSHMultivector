...
from models.isax_MTree.isax_MTree_search import IsaxMTreeSearcher
...
class IsaxMTreeRetrieve(HammingRetrieve):
    ...
    def prepare_searcher(self):
        self.searcher = IsaxMTreeSearcher(self.config, len(self.corpus.corpus_list))
    ...
    def save_ranks(self, scores, indices):
        path = r"{}/isax_mtree.run.gz".format(self.rank_path)
    ...
    def _create_save_path(self):
        save_dir = r"{}/isax_mtree/{}".format(self.config.results_save_to, self.config.dataset)
