...
from models.ann_mvdr.ann_mvdr_search import AnnMvdrSearcher
...
class AnnMvdrRetrieve(BaseRetrieve):
    ...
    def prepare_searcher(self):
        self.searcher = AnnMvdrSearcher(self.config, len(self.corpus.corpus_list))
    ...
    def _create_save_path(self):
        save_dir = r"{}/ann_mvdr/{}/{}".format(self.config.results_save_to, self.config.dataset, self.config.ann_type)
